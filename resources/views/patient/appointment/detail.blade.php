...
@section('main-visual')
    <div class="page-wrapper">
        ...
        <a href="{{ route('patient.get-all-appointment', ['patientId' => $appointment->patient_id]) }}"
            class="btn btn-gray">Back</a>
        <div class="text-center mt-4 p-3 border-top">
            <p><strong>Hospital Contact:</strong> +959 23423422 | +959 234234324 | <a href="http://localhost:8000/">info@Doctor appointment.com</a>
            </p>
